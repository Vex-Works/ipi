...
public sealed class LucideIcon : FrameworkElement
{
    ...
    private static string GetPath(string icon) => (icon ?? "").Trim().ToLowerInvariant() switch
    {
        ...
        "folder-open" => "M3.5 8V6.5A1.5 1.5 0 0 1 5 5h5l2 2h6a1.5 1.5 0 0 1 1.5 1.5V10 M4.5 10h16l-2.4 8.5H5.9z",
        ...
        "volume-2" => "M11 5 6 9H3v6h3l5 4z M15.5 8.5a5 5 0 0 1 0 7 M18 6a8.5 8.5 0 0 1 0 12",
        "volume-x" => "M11 5 6 9H3v6h3l5 4z M16 10l5 5 M21 10l-5 5",
